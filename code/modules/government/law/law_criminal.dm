...
/datum/law/criminal/property
	...
	notes = "Add reimburse value of destroyed property to the victim\
	A step up from vandalism, this covers any actual damage done to the \
...
/datum/law/criminal/animal
	...
	Geese are not included under this, as they are a danger to citizens."
...
/datum/law/criminal/theft
	...
	notes = "Also return of items or equal value of credits.\
	Note that taking items that are meant for public use all for yourself \
...
/datum/law/criminal/gta
	...
	notes = "Also return of items or equal value of credits.\
	Make sure the car wasn't handed to the suspect before you charge them with GTA."
...
/datum/law/criminal/fraud
	...
	notes = "Also seizure of all funds illegally acquired or 50% of total assets, whichever is higher.\
	This includes breaking a written contract and abusing government resources for private gain, \
...
/datum/law/criminal/contempt
	...
	notes = "Only applies in within court. Fine should be discretionary based on the judge or court official invovled."
...
/datum/law/criminal/tax_evasion
    ...
    notes = "All taxes witheld to be paid immediately from available assets.\
    For a business owner to be charged with this, there needs to be evidence that they were aware this was taking place. Business owners who are \
