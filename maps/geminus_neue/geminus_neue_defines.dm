...
/datum/map/geminus_neue
	...
	dock_name     = "the Residential District"
	...
	shuttle_docked_message = "The scheduled air shuttle to %dock_name% has arrived far east of the city. It will depart in approximately %ETD%."
